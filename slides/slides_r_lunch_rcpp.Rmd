...
`Rcpp` provides a high-level syntax for declaring `C++` functions easily. Here are some example comparing `R` and `Rcpp` syntax.
...
The `Rcpp` library provide a variety of already implemented functions that mimics `R` functions.
