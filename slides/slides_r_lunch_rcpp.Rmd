...
```{r echo=FALSE, fig.align='center', out.width=350, out.height=150}
...
---
.pull-right[![](assets/armadillo_logo2.png)]
...
Once `RcppArmadillo` has been installed with 
```{r, eval =F}
install.packages("RcppArmadillo")
```

One can source a `.cpp` file that make use of `Armadillo`.
