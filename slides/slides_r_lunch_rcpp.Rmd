...
| Operation| R |Rcpp|
|:---:|:---:|:---:|
| Vector constructor | `vector(mode = "numeric", length = 5)` | `NumericVector xx(5);` |
| Matrix constructor |`X = matrix(0,10,10)` |`NumericMatrix xx(5, 5);`|
...
This statistical quantity is used in the context of inference of latent stochastic models used in time series analysis. The algorithm to 
