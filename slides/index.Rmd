...
- Presente code with highlights

---
# Use case: The Haar Wavelet Variance 
## `C++` code mixing `Armadillo`, `RCpp` and `C++`

- side by side comparison synthax
...
<a href="mailto:garth.tarr@sydney.edu.au">
.white[`r icon::fontawesome("paper-plane")` Samuel.Orso@unige.ch]
</a>



<a href="http://github.com/garthtarr">
.white[`r icon::fontawesome("github")` @samorso]
</a>


<a href="https://github.com/SMAC-Group/r_lunch_rcpp">
.white[`r icon::fontawesome("link")` SMAC-Group/r_lunch_rcpp]
</a>
...
## Installing `r icon::fontawesome("download")`

The **xaringan** package is on CRAN, but I recommend installing the development release from `r icon::fontawesome("github")`
...
These are available in the assets folder of the GitHub code repository [`r icon::fontawesome("github")` `garthtarr/sydney_xaringan`](http://github.com/garthtarr/sydney_xaringan/assets)

To make things easy to get started, I recommend downloading a copy of the `sydney_xaringan` repo [`r icon::fontawesome("file-archive")`](https://github.com/garthtarr/sydney_xaringan/archive/master.zip) and make changes to the template. 
...
## Why xaringan/remark.js? `r icon::fontawesome("check-circle")`
...
## Why **not** xaringan/remark.js? `r icon::fontawesome("times-circle")`
...
## Content boxes `r icon::fontawesome("box", )`
...
## Quotes `r icon::fontawesome("quote-right")`
...
```
.blockquote[
### `r knitr::inline_expr('icon::fontawesome("comment-dots")')` Statistical 
thinking
- Point 1
]
```
...
.blockquote[
### `r icon::fontawesome("comment-dots")` Statistical thinking
- Point 1
]
...
```
.blockquote[
### `r knitr::inline_expr('icon::fontawesome("location-arrow")')` Aim
- Point 1
]
```
]
.blockquote[
### `r icon::fontawesome("location-arrow")` Aim
- Point 1
]
...
## Lists, increments and footnotes`r icon::fontawesome("list")`
...
## Icons `r icon::fontawesome("exclamation")`
...
`r icon::fontawesome("bell")` created using 

`` `r knitr::inline_expr('icon::fontawesome("bell")')` ``


<br>

For more info see [the `r icon::fontawesome("github")` repo](https://github.com/ropenscilabs/icon).

]

---

## Data tables `r icon::fontawesome("table")`
...
## FAQ `r icon::fontawesome("question-circle")`
...
## Two columns! `r icon::fontawesome("columns")`
...
## R code and highlighting `r icon::fontawesome("r-project")`
...
## R code and plot output `r icon::fontawesome("r-project")`
...
## Citations and references `r icon::fontawesome("book")`
...
<a href="mailto:garth.tarr@sydney.edu.au">
.white[`r icon::fontawesome("paper-plane")` garth.tarr@sydney.edu.au]
</a>

<a href="http://garthtarr.github.io/sydney_xaringan">
.white[`r icon::fontawesome("link")` garthtarr.github.io/sydney_xaringan]
</a>

<a href="http://twitter.com/garthtarr">
.white[`r icon::fontawesome("twitter")` @garthtarr]
</a>

<a href="http://github.com/garthtarr">
.white[`r icon::fontawesome("github")` @garthtarr]
</a>
